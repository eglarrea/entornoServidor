...
<html lang="es">
    ...
    <body>
        <?php  include_once '../lib/constComunes.php'?>
        <?php  include_once ROUTE_CONTROLLER.'validateForm.php'?>
        ...
        <div class="container">
            ...
            <?php } ?>
            <form id="formNombre" name="form_reserva" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="POST">
