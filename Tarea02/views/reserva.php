        ...
        <div class="container">
            <form id="formNombre" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="POST">
                ...
                <div class="col-md-4">
                    ...
                    <input class="form-control <?php echo  $arrayErrClass['libroErrClass'];?>" type="text" id="flibro" name="libro" value="<?php echo $arrayFormulario['libro']?>">
                ...
                <div class="col-md-4">
                    ...
                    <input class="form-control <?php echo  $arrayErrClass['fechaErrClass'];?>" type="date" id="ffecha" name="fecha" value="<?php echo $arrayFormulario['fecha']?>">
                    <div  class="invalid-feedback">
                ...
                <input type="submit" id="butAniadirSocio" value="enviar">
            </form> 
        </div>
